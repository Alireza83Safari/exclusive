...
export { default as SelectList } from "./Share/SelectList";
export { default as Timer } from "./Share/Timer";
...
export { default as AccountMenu } from "./Shop/Account/AccountMenu";
export { default as AccountOrders } from "./Shop/Account/Order/AccountOrders";
export { default as AccountUserInfo } from "./Shop/Account/UserInfo/AccountUserInfo";

/// address
export { default as AccountAddress } from "./Shop/Account/Address/AccountAddress";
export { default as AddAddress } from "./Shop/Account/Address/AddAddress";
export { default as EditAddress } from "./Shop/Account/Address/EditAddress";

/// favorite
export { default as FavoriteProducts } from "./Shop/Account/Favorite/FavoriteProducts";
export { default as FavoriteTemplate } from "./Shop/Account/Favorite/FavoriteTemplate";

/// comment
export { default as Comment } from "./Shop/Comment/Comment";
export { default as AddComment } from "./Shop/Comment/AddComment";
export { default as CommentDetails } from "./Shop/Comment/CommentDetails";

/// cart
export { default as CartFooter } from "./Shop/Cart/CartFooter";
export { default as CartHeader } from "./Shop/Cart/CartHeader";
export { default as CartInfo } from "./Shop/Cart/CartInfo";
export { default as CartItem } from "./Shop/Cart/CartItem";

/// content
export { default as Banner } from "./Shop/Banner/Banner";
export { default as Content } from "./Shop/Banner/Content";
export { default as Menu } from "./Shop/Banner/Menu";

/// footer
export { default as Footer } from "./Shop/Footer/Footer";

/// header
export { default as Header } from "./Shop/Header/Header";

/// home page
export { default as Arrival } from "./Shop/Homepage/Arrival";
export { default as Brand } from "./Shop/Homepage/Brand";
export { default as Options } from "./Shop/Homepage/Options";
export { default as Suggestion } from "./Shop/Homepage/Suggestion";

/// product
export { default as FilterProducts } from "./Shop/Product/FilterProducts";
export { default as ProductTemplate } from "./Shop/Product/ProductTemplate";

/// product details
export { default as Details } from "./Shop/ProductDetails/Details";
export { default as DetailsImage } from "./Shop/ProductDetails/DetailsImage";
export { default as DetailsInfo } from "./Shop/ProductDetails/DetailsInfo";
export { default as RelatedProducts } from "./Shop/ProductDetails/RelatedProducts";

/// about
export { default as AboutContent } from "./Shop/About/AboutContent";
export { default as AboutInfo } from "./Shop/About/AboutInfo";
export { default as AboutPersons } from "./Shop/About/AboutPersons";

/// contact
export { default as ContactForm } from "./Shop/Contact/ContactForm";
export { default as ContactInfo } from "./Shop/Contact/ContactInfo";

////
export { default as ProductSlider } from "./Shop/ProductSlider";
export { default as Profile } from "./Shop/Profile";

/// skeleton
export { default as HeaderSkeleton } from "./Skeleton/HeaderSkeleton";
export { default as BannerMenuSkeleton } from "./Skeleton/BannerMenuSkeleton";
export { default as BannerSkeleton } from "./Skeleton/BannerSkeleton";
export { default as ProductSliderSkeleton } from "./Skeleton/ProductSliderSkeleton";
export { default as BrandsSkeleton } from "./Skeleton/BrandsSkeleton";
export { default as SuggestionSkeleton } from "./Skeleton/SuggestionSkeleton";
export { default as ArrivalSkeleton } from "./Skeleton/ArrivalSkeleton";
