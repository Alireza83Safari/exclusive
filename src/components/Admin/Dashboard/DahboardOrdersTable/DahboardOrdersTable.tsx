...
import { orderAdminApi } from "../../../../Redux/apis/admin/orderAdminApi";
import { DashboardTableSkeleton } from "../../../index";

const DahboardOrdersTable = () => {
...
export default DahboardOrdersTable;
