...
import { EditBrandProps } from "./EditBrand.interface";
...
export default function EditBrand(props: EditBrandProps) {
  const { showEditModal, setShownEditModal, editBrandId, refetchBrands } =
    props;
  ...
  return (
    <Modal
      open={showEditModal}
      onClose={() => setShownEditModal(false)}
