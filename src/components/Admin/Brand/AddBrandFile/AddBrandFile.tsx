...
import { AddBrandFileProps } from "./AddBrandFile.interface";

function AddBrandFile(props: AddBrandFileProps) {
  const {
    refetchBrands,
    createdBrandId,
    setShowAddBrand,
  ...
  const createBrandHandler = () => {
    ...
    addBrandImage({ itemId: createdBrandId, image: imageFormData });
    adminAxios.post(`/file/uploadImage/${createdBrandId}/2`, imageFormData);
  };
