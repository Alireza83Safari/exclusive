...
import { AddRoleProps } from "./AddRole.interface";

function AddRole(props: AddRoleProps) {
  const { refetchRoles, permissions, setShowAddModal } = props;
  ...
  return reactDOM.createPortal(
    <section className="fixed top-1/2 left-1/2 transform -translate-x-1/2 bg-[#dddd] -translate-y-1/2 z-10 w-full h-screen flex items-center justify-center transition duration-400">
