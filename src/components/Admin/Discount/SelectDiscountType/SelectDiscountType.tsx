...
import { SelectDiscountTypeProps } from "./SelectDiscountType.interface";

export default function SelectDiscountType(props: SelectDiscountTypeProps) {
  const { setDiscountType, discountType } = props;
