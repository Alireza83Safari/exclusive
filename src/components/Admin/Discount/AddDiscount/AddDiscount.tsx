...
import { AddDiscountProps } from "./AddDiscount.interface";
import AddBrandSkeleton from "../../../Skeleton/Admin/Brand/AddBrandSkeleton";

function AddDiscount(props: AddDiscountProps) {
  const { refetchDiscount, discountType } = props;
