...
function Footer() {
  return (
    <footer className="w-full bg-black">
      <div className="xl:max-w-[1280px] md:max-w-[98%] w-full mx-auto relative mt-20 py-16 md:flex justify-between grid sm:grid-cols-3 grid-cols-1">
        <div className="md:mx-1 mx-3 my-3">
          <ul className="text-white">
            <li className="text-2xl font-semibold mb-4">
              <Link to={appRoutes.HOME}>Exclusive</Link>
            </li>
        ...
        <div className="text-white md:mx-1 mx-3 my-3">
          <ul>
            ...
            <li className="my-4">
              <Link to={appRoutes.ACCOUNT}>My Account</Link>
            </li>
            <li className="my-4">
              <Link to={appRoutes.LOGIN}>Login / Register</Link>
            </li>
            <li className="my-4">
            ...
            <li className="my-4">
              <Link to={appRoutes.ACCOUNT_FAVORITE}>favorite</Link>
            </li>
            <li className="my-4">
              <Link to={appRoutes.PRODUCTS}>Shop</Link>
            </li>
          </ul>
        </div>
